            ...
            <div class="single-page-row" id="detail-21">
                <div class="col-md-6 single-top-left">
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="{{asset('frontend_assets/images/s1.jpg')}}">
                                <div class="thumb-image detail_images"> <img src="{{asset('frontend_assets/images/s1.jpg')}}" data-imagezoom="true" class="img-responsive" alt=""> </div>
                            </li>
                            <li data-thumb="{{asset('frontend_assets/images/s2.jpg')}}">
                                <div class="thumb-image"> <img src="{{asset('frontend_assets/images/s2.jpg')}}" data-imagezoom="true" class="img-responsive" alt=""> </div>
                            </li>
                            <li data-thumb="{{asset('frontend_assets/images/s3.jpg')}}">
                                <div class="thumb-image"> <img src="{{asset('frontend_assets/images/s3.jpg')}}" data-imagezoom="true" class="img-responsive" alt=""> </div>
                            </li>
                        </ul>
                    </div>
                </div>
