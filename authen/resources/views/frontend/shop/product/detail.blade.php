        ...
        <div class="single-page">
            <div class="single-page-row" id="detail-21">
                ...
                <div class="col-md-6 single-top-right">
                    ...
                    <p>Processing Time: {{$product->ship_info}} </p>
                    ...
                    <div class="single-price">
                        <ul>
                            <li>VND {{number_format($product->priceSale,0,'.','.')}}</li>
                            <li><del>VND {{number_format($product->priceCore,0,'.','.')}}</del></li>
                            <?php
                                $core = $product->priceCore;
                                $sale = $product->priceSale;
                                if ($core > $sale) {
                                    $discount = round(($core - $sale) / $core *100);
                                } else {
                                    $discount = 0;
                                }
                            ?>
