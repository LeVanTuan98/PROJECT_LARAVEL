        ...
        <div class="form-three widget-shadow">
            <form name="brand" action="{{url('admin/shop/brand/'.$brand->id)}}" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="link" class="form-control1" id="focusedinput" value="{{$brand->slug}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input id="thumbnai" class="form-control" type="text" name="images" value="{{$brand->images}}" placeholder="Hình ảnh">

                        <img id="holder" src="{{asset($brand->images)}}" style="margin-top:15px;max-height:100px;">
                    </div>
